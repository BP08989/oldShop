...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('BPashkevichProductBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('BPashkevich\ProductBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('BPashkevich\ProductBundle\Form\ImageType', $image);
